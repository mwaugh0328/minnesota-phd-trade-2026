...
Now there is a second GE effect $\sum_k \pi_{nk} \frac{d \ln w_k}{d \ln d_{nj}}$: a share-weighted sum of how all source prices change through wage adjustments. This has a strong analog to Hulton's theorem and then the Baquee Farhi stuff. I need to expand more on this.
...
\item Notice, that both my equation and ACR handle GE effects. However, one can see how the ACR and the demand system that they impose dramatically simplifies things when GE is considered | all of that stuff is baked into the home trade share.
